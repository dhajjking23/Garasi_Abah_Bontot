...
class PembagianLabaScreen extends ConsumerWidget {
  ...
  void _konfirmasiTutupBuku(BuildContext context, WidgetRef ref) {
    String? errorMsg;
    bool loading = false;
    bool settelKasbonDanTalang = true;
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          CheckboxListTile(
                            ...
                            dense: true,
                            title: const Text(
                                'Sekaligus lunaskan Kasbon & Dana Talang partner',
                                style: TextStyle(fontSize: 13, fontWeight: FontWeight.w600)),
                            subtitle: const Text(
                              'Kalau aktif, semua kasbon & dana talang aktif tiap '
                              'partner ikut dilunasi sekarang (cash/bank ikut '
                              'bergerak). Kalau tidak, tetap outstanding untuk '
                              'diselesaikan manual atau dibawa ke periode berikutnya.',
                              style: TextStyle(fontSize: 11, color: Colors.black54),
                            ),
                            value: settelKasbonDanTalang,
                            onChanged: (v) => setDialogState(
                                () => settelKasbonDanTalang = v ?? true),
                          ),
                          if (errorMsg != null) ...[
                            const SizedBox(height: 12),
                            Container(
                            ...
                            : () async {
                                ...
                                try {
                                  ...
                                  await service.tutupBukuDanBagiLaba(
                                    ...
                                    settelKasbonDanTalang: settelKasbonDanTalang,
                                  );
