...
import '../../widgets/motion/skeleton.dart';
...
import 'total_aset_detail_screen.dart';
      ...
      body: RefreshIndicator(
        ...
        child: summaryAsync.when(
          loading: () => ListView(
            ...
            children: [
              const SkeletonBox(height: 60, borderRadius: BorderRadius.all(Radius.circular(16))),
              ...
              GridView.count(
                ...
                children: List.generate(10, (_) => const SkeletonCard()),
              ),
            ],
          ),
              ...
              children: [
                ...
                GridView.count(
                  ...
                  children: StaggeredEntrance.staggeredChildren([
                    ...
                    // V5.6 — kartu "Pengeluaran" (total periode aktif),
                    // menggantikan kartu "Piutang Kasbon" — Kasbon tetap
                    // ada & bisa diakses lewat menu Pembukuan seperti biasa.
                    SummaryCard(
                      label: 'Pengeluaran',
                      value: periodeAktifAsync.maybeWhen(
                        data: (p) => p?.id != null
                            ? ref.watch(laporanPeriodeProvider(p!.id!)).maybeWhen(
                                  data: (lap) => lap.totalPengeluaran,
                                  orElse: () => 0,
                                )
                            : 0,
                        orElse: () => 0,
                    ...
                    // V5.7 — kartu "Kasbon Karyawan" menggantikan "Piutang
                    // Penjualan (DP)" (nilai piutang penjualan tetap
                    // terhitung utuh di dalam Total Aset, cuma kartu
                    // pintasannya yang diganti sesuai permintaan).
                    SummaryCard(
                    ...
                    SummaryCard(
                      ...
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (_) => const TotalAsetDetailScreen()),
                        ).then((_) => refreshSemuaData(ref));
                      },
                    ),
                    SummaryCard(
