          ...
          Expanded(
            child: motorAsync.when(
              ...
              data: (motorList) {
                ...
                // V5.5 — tab "Semua": motor TERSEDIA tampil paling atas,
                // motor TERJUAL dipindah ke bawah. Split + concat (bukan
                // List.sort, yang di Dart TIDAK stabil) supaya urutan asli
                // di dalam masing-masing kelompok tetap terjaga persis.
                final sorted = _filterStatus == null
                    ? [
                        ...filtered.where((m) => !m.isTerjual),
                        ...filtered.where((m) => m.isTerjual),
                      ]
                    : filtered;
            ...
            children: [
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    // V5.5 — plat nomor jadi identitas utama (banyak motor
                    // tipe/tahun sama, plat yang membedakan tiap unit).
                    Text(
                      motor.platNomor?.isNotEmpty == true
                          ? motor.platNomor!
                          : '(Plat belum diisi)',
                    ...
                    Text(
                      '${motor.namaLengkap} • ${motor.kodeMotor}',
