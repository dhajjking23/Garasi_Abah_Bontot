    ...
    return Scaffold(
      ...
      body: kasbonAsync.when(
        loading: () => ListView(
          ...
          children: [
            const SkeletonBox(height: 64, borderRadius: BorderRadius.all(Radius.circular(16))),
            const SizedBox(height: 16),
            ...List.generate(
              6,
              (_) => const Padding(
                padding: EdgeInsets.only(bottom: 8),
                child: SkeletonBox(height: 72, borderRadius: BorderRadius.all(Radius.circular(12))),
              ),
            ),
          ],
        ),
              ...
              Expanded(
                child: ListView.separated(
                  ...
                  itemBuilder: (context, i) {
                    ...
                    return FadeSlideIn(
                      delay: AppMotion.staggerDelayFor(i),
                      child: Card(
                      child: ListTile(
                        onTap: lunas
                            ? null
