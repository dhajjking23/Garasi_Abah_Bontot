...
class PeriodeModel extends Equatable {
  ...
  /// V5.9.4 — "Opening Company Assets" REFERENSI murni (Mega Prompt
  /// Section M/§19-21): total aset milik perusahaan (Cash+Bank+Stok+DP+
  /// Piutang) di akhir closing periode SEBELUMNYA, dipakai sebagai
  /// patokan modal awal periode baru. BUKAN cash injection — beda dari
  /// [modalAwalCash]/[modalAwalBank] yang MEMANG menyuntik saldo fisik
  /// (dipakai untuk periode pertama/penambahan modal riil). Untuk
  /// periode carry-forward (dibuat lewat
  /// `PeriodeRepository.bukaPeriodeBaruDariClosing`), field ini diisi
  /// dengan total aset hasil `FinancialBalanceEngine.calculateAssets()`
  /// SAAT closing, dan modalAwalCash/modalAwalBank tetap 0 (karena
  /// cash/bank/stok/piutang sudah otomatis carry-forward, TIDAK perlu
  /// disuntik ulang -- menyuntik lagi akan dobel-hitung).
  /// Default 0 untuk periode lama (sebelum field ini ada).
  final double modalAwalTotalAset;
  ...
  Map<String, dynamic> toMap() {
    return {
      ...
      'modal_awal_total_aset': modalAwalTotalAset,
  ...
  factory PeriodeModel.fromMap(Map<String, dynamic> map) {
    ...
    return PeriodeModel(
      ...
      modalAwalTotalAset:
          (map['modal_awal_total_aset'] as num?)?.toDouble() ?? 0,
  ...
  PeriodeModel copyWith({
    ...
    return PeriodeModel(
      ...
      modalAwalTotalAset: modalAwalTotalAset ?? this.modalAwalTotalAset,
