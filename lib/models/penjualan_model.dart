...
class PenjualanModel extends Equatable {
  ...
  final double laba;
  /// V5.5 — biaya calo/perantara (opsional). Dipotong dari harga jual
  /// SEBELUM laba dihitung: laba = hargaJual - biayaCalo - modalMotor.
  /// Tidak memengaruhi apa yang ditagih ke pembeli (hargaJual /
  /// cash+transferDiterima tetap utuh) — murni pengurang laba perusahaan.
  ...
  /// Hasil penjualan bersih setelah dipotong biaya calo (bukan sisa piutang).
  double get hasilBersih => hargaJual - biayaCalo;
  ...
  factory PenjualanModel.fromMap(Map<String, dynamic> map) {
    return PenjualanModel(
      ...
      biayaCalo: (map['biaya_calo'] as num?)?.toDouble() ?? 0,
  ...
  PenjualanModel copyWith({
    ...
    return PenjualanModel(
      ...
      laba: laba ?? this.laba,
      biayaCalo: biayaCalo ?? this.biayaCalo,
