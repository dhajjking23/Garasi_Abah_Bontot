...
class DashboardService {
  ...
  Future<DashboardSummary> getSummary() async {
    ...
    if (periodeAktif != null) {
      ...
      // V5.7 — FIX: sebelumnya cuma menjumlahkan Pengeluaran(Transfer) +
      // manual, PADAHAL biaya transfer juga tersimpan di tabel motor,
      // motor_cost, dan dana_talang (kolom biaya_admin_transfer, dipakai
      // sejak V4.2.1 untuk transaksi apa pun yang memotong Saldo Bank via
      // Transfer). Sekarang disatukan persis seperti algoritma yang SUDAH
      // BENAR di laporan_service.dart (totalBiayaTransferGabungan), supaya
      // kartu Dashboard & halaman Biaya Transfer tidak lagi understate.
      ...
      totalBiayaTransfer += (motorFeeResult.first['total'] as num).toDouble();
      ...
      // Kasbon TIDAK punya periode_id (konsisten dengan piutang kasbon
      // yang juga dihitung global) -- biayanya global juga, sama seperti
      ...
      totalBiayaTransfer += (kasbonFeeResult.first['total'] as num).toDouble();
    }
