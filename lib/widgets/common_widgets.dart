...
import 'motion/animated_count_up.dart';
...
class SummaryCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // V5.9.11-MOTION: TIDAK dibungkus PressableScale di sini -- InkWell
    // sudah punya feedback tekan sendiri (ripple), membungkusnya dengan
    // GestureDetector.onTap terpisah akan memicu callback onTap DUA
    // KALI (GestureDetector + InkWell bersaing menangkap tap yang sama).
    // Ripple InkWell sudah cukup memenuhi §5/§15 (touch feedback).
    return InkWell(
      onTap: onTap,
      borderRadius: BorderRadius.circular(16),
      child: card,
